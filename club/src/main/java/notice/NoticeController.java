...
public class NoticeController {
	...
	public String noticeList(NoticeVO vo, Model model, CategoryVO cVO, @RequestParam("board_id")int board_id, @RequestParam("spot_num") String spot_num) {
	...
	public String noticeInsert(NoticeVO vo, HttpServletRequest req, 
		...
		return "redirect:/board/notice/noticeList.do?spot_num="+spot_num+"&category_id="+vo.getCategory_id()+"&board_id="+vo.getBoard_id();
	}
	//공지사항 상세보기 페이지
	...
	public String noticeDelete(@RequestParam("post_id")int post_id, NoticeVO vo, @RequestParam("spot_num")String spot_num) {
		...
		return "redirect:/board/notice/noticeList.do?spot_num="+spot_num+"&category_id="+vo.getCategory_id()+"&board_id=3";
	}
	//공지사항 수정하기 페이지
	...
	public String noticeUpdate(NoticeVO vo, 
		...
		return "redirect:/board/notice/noticeWriteView.do?spot_num="+spot_num+"&board_id=3&category_id="+vo.getCategory_id()+"&post_id="+vo.getPost_id();
	}
