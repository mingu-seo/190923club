...
<!-- E N D :: headerArea-->
<form method="post" name="frm" id="frm" action="infoUpdate.do" enctype="multipart/form-data">
<input type="hidden" name="num" value="${infovo.num}">
<div class="wrap">
    <div class="container">
        <h2 style="padding : 10 0px;">Info 수정</h2>
    </div>
    <div class="container">
            <div class="group">      
	            <input type="text" name="name" id="name" value="${infovo.name}">
    ...
    <div class="container">
            <div class="group">      
	            <input type="text" name="content" value="${infovo.content }">
	            <span class="highlight"></span>
	            <span class="bar"></span>
	            <label>Info 내용</label>
            </div>
    ...
    <div class="container">
            ...
            <div class="group">
            	<div id="thumb_img1" onfocus="this.value='';">${infovo.file}</div>
            </div>
    </div>
