							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									<tr>
										...
										<td colspan="10">
											<input type="text" id="title" name="notice_subject" class="w100" title="제목을 입력해주세요" value="${vo.notice_subject}"/>	
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="notice_content">*내용</label></th>
										<td colspan="10">
											<textarea id="contents" name="notice_content" title="내용을 입력해주세요" style="width:100%;" >"${vo.notice_content}"</textarea>	
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="notice_file">첨부파일</label></th>
										<td colspan="10">
											<input type="file" id="filename_tmp" name="filename_tmp" class="w100" title="첨부파일을 업로드 해주세요." value="${vo.notice_file }"/>	
										</td>
									</tr>
								</tbody>
							</table>
