...
<div class="wrap">
    ...
    <div class="container">
         <div class="group">
	          <input type="text" name="name" id="name" class="font" maxlength="20">
        ...
        <div class="group">      
            <input type="text" name="content" id="content" class="font">
            <span class="highlight"></span>
            <span class="bar"></span>
            <label>SPOT 소개</label>
         </div>
         <div class="group">      
            <input type="text" name="question" id="question" class="font">
            <span class="highlight"></span>
            <span class="bar"></span>
            <label>SPOT가입 질문</label>
         </div>
         <div class="group">      
            <input type="text" name="tel" id="tel" class="font">
            <span class="highlight"></span>
            <span class="bar"></span>
            <label>Tel</label>
         </div>
         <div class="group">      
            <input type="text" name="email" id="email" class="font">
            <span class="highlight"></span>
            <span class="bar"></span>
            <label>Email</label>
        </div>
		...
		&nbsp;    
		<a href="javascript:join();" class="spotRegistbutton">확 인</a>
    </div>
